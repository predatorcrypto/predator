...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Predator coin predatorcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  predatorcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded predatorcoin transaction") + "\n" +
              "  predatorcoin-tx [options] -create [commands]   " + _("Create hex-encoded predatorcoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded predatorcoin transaction
