...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "PRDCoinNetwork") type = PRDCoinNetwork;
    if(strType == "PRDCoinNetworkVariable") type = PRDCoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == PRDCoinNetwork) s = "PRDCoinNetwork";
    if(type == PRDCoinNetworkVariable) s = "PRDCoinNetworkVariable";
