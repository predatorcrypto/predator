...
#define BOOST_TEST_MODULE PRDCoin Test Suite

#include "test_predatorcoin.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_predatorcoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
