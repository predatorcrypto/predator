    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Predator coin") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Predator coin"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  predatorcoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the PRDCoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
PrivateSend uses an innovative process to mix your inputs with the inputs of two other predatorcoin, without having your coins ever leave your wallet. \
...
These denominations are 0.01 PRD, 0.1 PRD, 1 PRD and 10 PRD -- sort of like the paper money you use every day.</li> \
...
<li>When two other predatorcoin send similar messages, indicating that they wish to mix the same denomination, a mixing session begins. \
...
For more info see <a href=\"https://predatorcrypto.atlassian.net/wiki/display/DOC/PrivateSend\">https://predatorcrypto.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Predator coin is shutting down...") + "<br /><br />" +
