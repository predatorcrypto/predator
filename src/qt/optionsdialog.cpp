    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("PRD-light"), QVariant("light"));
    ui->theme->addItem(QString("PRD-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("PRD-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("PRD-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("PRD-traditional"), QVariant("trad"));
