    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Predator coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a PRDCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and predatorcoin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Predator coin"), this);
    aboutAction->setStatusTip(tr("Show information about Predator coin"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Predator coin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your PRDCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified PRDCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a predatorcoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Predator coin help message to get a list with possible Predator coin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Predator coin client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to PRDCoin network", "", count));
    } else {
...
{
    QString strTitle = tr("Predator coin"); // default title
