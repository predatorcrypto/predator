...
Only requiring some minor changes is predatorcoin.cpp.
...
Changes to predatorcoin.cpp
----------------------
predatorcoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
