...
This mechanism has been integrated into Bitcore-Node-PRDCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/predatorcrypto/insight-api-predatorcoin#web-socket-api](https://github.com/predatorcrypto/insight-api-predatorcoin#web-socket-api)
* API: [https://github.com/predatorcrypto/insight-api-predatorcoin#instantsend-transactions](https://github.com/predatorcrypto/insight-api-predatorcoin#instantsend-transactions)
...
By default, the Predator coin daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Predator coin daemon:
